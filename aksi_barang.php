...
if($aksi == "delete")
{
    ...
    {
        echo "<br><hr><br> Delete berhasil dijalankan! Untuk melihat kembali data Barang, silakan klik"; 
        ?><a href="halaman_utama.php?tabel_barang=$tabel_barang">
            <input type="button" class="tombol" value="Back">
        </a><?php
    }
    else
    {
...
<form action="update_barang.php" method="POST">
    <table>
        ...
        <tr>
            <td><input type="text" name="HargaSatuan" size="25px" value="<?php echo $isi['HargaSatuan']; ?>"></td>
        </tr>
