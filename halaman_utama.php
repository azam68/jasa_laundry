...
<head>
	...
	<script type='text/javascript'>
		msg = " L24 LAUNDRY ONLINE ";

		msg = " | PREMIUM LAUNDRY | BASED JOGJA KOTA --- " + msg;
		pos = 0;
...
<body>
	...
	<div id="luar">
		<nav>
			...
			$formulir_transaksi = "formulir_transaksi.php";
			$formulir_pembelian = "formulir_pembelian.php";
			$formulir_rincian_pembelian = "formulir_rincian_pembelian.php";
			$formulir_rincian_transaksi = "formulir_rincian_transaksi.php";
			$formulir_pemakaian_barang = "formulir_pemakaian_barang.php";
		...
		<div id="isi">
			...
			<div id="menu_kiri">
				...
				<div id="menu_kontak">
					...
					<p><img src="logo/email2.png" width="25" height="25" align="center">&nbsp;&nbsp;l24laundry@gmail.com
					</p><br>
				</div>
				...
				<div id="menu_sosial">
					...
					<h2>Sosial Media</h2>
					<hr color="#0263A0"><br>
					<p>&nbsp;&nbsp;&nbsp;&nbsp;<a href="http://www.instagram.com/l24laundry" target="_blank"><img
								src="logo/instagram.png" width="40" height="40"
								align="center">&nbsp;&nbsp;&nbsp;&nbsp;</a>
						<a href="http://www.facebook.com/l24laundry" target="_blank"><img src="logo/facebbok.png"
								width="40" height="40" align="center">&nbsp;&nbsp;&nbsp;&nbsp;</a>
						<a href="http://www.twitter.com/L24Laundry" target="_blank"><img src="logo/twitter.png" width="40"
			...
			<div id="konten">
				...
				else if(isset($_GET['formulir_transaksi'])) {
				require_once $formulir_transaksi;
				}
				else if(isset($_GET['formulir_pembelian']))
				{
					require_once $formulir_pembelian;
				}
				else if(isset($_GET['formulir_rincian_pembelian']))
				{
					require_once $formulir_rincian_pembelian;
				}
				else if(isset($_GET['formulir_rincian_transaksi']))
				{
					require_once $formulir_rincian_transaksi;
				}
				else if(isset($_GET['formulir_pemakaian_barang']))
				{
					require_once $formulir_pemakaian_barang;
				}
