...
else
{
    ...
    <table>
        ...
        while ($isi = mysqli_fetch_array($query))
        {
            ...
            <tr>
                <td>
                    <input type="text" name='NIK' size="25px" value="<?php echo $isi['NIK']; ?>" maxlength="5" style="color:#888;" readonly>
                </td>
            </tr>
            ...
            <tr>
                <td>
                    ...
                    while ($isi2 = mysqli_fetch_array($query2))
                    {
                        ...
                        ?>
                        <input type="text" size="25px" value="<?php echo $NmKaryawan; ?>" maxlength="5" style="color:#888;" readonly>
                    <?php } ?>
                </td>
            </tr>
            ...
            <tr>
                <td>
                    <select name="TypeUser">
                        ...
                        <?php } elseif ($isi['TypeUser'] == "operator") { ?>
